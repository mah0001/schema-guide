...
Over the last decade, there has been a significant increase in the supply of socio-economic data available to researchers, analysts, and decision-makers. The demand for data is also growing, and tools and methods available to exploit data in a more integrated manner are being developed at a fast pace. This brings opportunities to increase the use and thus the social and economic value of existing data. "Data that were initially collected with one intention can be reused for a completely different purpose. (…) Because the potential of data to serve a productive use is essentially limitless, enabling the reuse and repurposing of data is critical if data are to lead to better lives.” ([World Bank, World Development Report 2021](https://www.worldbank.org/en/publication/wdr2021)) 

However, data can be challenging to find, access, and use, and analysts often spend an unreasonable amount of time wrangling data. Researchers rely heavily on tribal knowledge to identify the datasets that best fit their needs, leaving many valuable datasets underutilized.

To promote the responsible dissemination and use of data, data libraries and repositories play a crucial role. These libraries can maintain openly-accessible online catalogs of well-curated data, making them discoverable, visible, and usable. To achieve this, advanced search algorithms, operating as recommender systems and search engine optimized, must power these catalogs. Moreover, to enhance the usability of data, detailed documentation, and convenient formats and mode of dissemination should be provided to users. 

To effectively achieve the aforementioned objectives, it is essential to have comprehensive and structured metadata. Adopting metadata standards and schemas[^1] is a practical and efficient solution to promoting the completeness and quality of metadata, as well as the inter-operability of data catalogs that utilize them. These standards and schemas must be tailored to the type of data being documented. This Guide offers a set of recommended standards and schemas and provides guidance and justification for their implementation.
