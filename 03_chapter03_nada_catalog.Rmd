...
Implementing Learn to Rank models may be challenging for data catalog administrators. Building the training dataset, fitting models, and implementing them, requires resources and advanced skills. As an intermediary solution, optimizing the implementation of Solr of ElasticSearch will in many cases contribute significantly (and often sufficiently) to the improvement of results ranking. For more information on the challenge and tools and methods available for relevancy engineering, see See D. Turnbull and J. Berryman (2016).
