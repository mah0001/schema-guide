...
<br>   
  ...
  ```
   ...
   - **`funders`** *[Optional ; Repeatable]* <br> ("funder" in ReDoc; fix and redo screenshot)
   <br>
   ![](./images/ReDoc_videos_28.JPG){width=100%}
   <br>
   This element is used to list the funder/sponsors of the video. If different funding agencies financed different stages of the production process, use the "role" attribute to distinguish them.
      - **`name`** *[Required ; Not repeatable ; String]* <br>
   ...
   - **`relation`** *[Optional ; Not repeatable, String]* <br>   @@@@ Added ("relations" in ReDoc; fix and redo screenshot)
   <br>
