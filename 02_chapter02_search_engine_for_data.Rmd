...
One search box, and options for more advanced search.
The searh should be parsed and the most relevant must be returned and displayed in a convenient manner. Then only should the user take advantage of additionsl features: filters, sort, advanced search, keywords suggestions.

#### Flexibility on the query

Submit a document as a query; use syntax in the query.
