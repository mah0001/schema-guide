...
Both Google and chatGPT mention the WorldBank as source. chatGPT provide results that differ from the information in the WB's website. Both fail to provide the basic necessary metadata on the indicator. GDP per capita in US$ corresponds to four different indicators.
