...
Suppose an analyst wants to study the correlation between education and inequality in Kenya. Such an analysis requires microdata from household surveys. A Google search for "data on inequality and education in Kenya" returns useful links, but mostly to publications and blogs. Among the top 40 results, none provides a link to a relevant dataset.  
...
A more specific query for "survey microdata on income inequality and education in Kenya" returns more relevant results, including a link to the *Kenya Integrated Household Budget Survey 2015-2016* from the microdata catalog maintained by the Kenya Bureau of Statistics. But the 49 rhe results returned by Google do not include relevant survey datasets that contain variables on education and on household income or expenditures, such as the *kenya Integrated Household Budget Survey 2005-2006*, or the multiple other surveys that collected data on education and on proxies of household income such as household expenditure or assets ownership.
