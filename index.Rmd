...
```
The volume and diversity of data made available to the research community are growing fast. But many valuable datasets remain largely under-exploited. To be used more extensively, data must be made easier to find, access, and analyze. This depends largely on the quality of the associated metadata. 

This document is a guide on the use of metadata standards and schemas for the documentation of socio-economic data. Its objective is to promote and facilitate the production and use of rich and structured metadata to improve the usability, the discoverability, and the use of data. Although it describes standards and schemas that are independent from any particular software application, it was written as a companion guide to a suite of open source tools and guidelines developed by or for the International Household Survey Network, including the [NADA cataloguing](http://nada.ihsn.org/) application and a Metadata Editor software. 

The Guide was written by Olivier Dupriez (Lead Statistician, World Bank) and Mehmood Asghar (Senior Data Engineer, World Bank). Kamwoo Lee (Data Scientist, World Bank) produced some of the examples of the use of metadata schemas included in the Guide and contributed to the testing of the schemas. Matthew Welch (Senior Economist-Statistician, World Bank) provided comments on the Guide, and Thijs Benschop (Data Scientist, World Bank) contributed to the development of the NADAR package. Emmanuel Blondel (Consultant) contributed much of chapter 6. Geoffrey Greenwell (Consultant) provided input to chapter 8. Tefera Bekele Degefu and Cathrine Machingauta (Data Scientists, World Bank) participated in the testing of the schemas and packages.
